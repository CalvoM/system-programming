...
//ANS -> word written at the end of the file, when opened in APPEND mode, data is appended at end i.e. SEEK_SET will always be the end of the file
#include "utils.h"

int main(int argc, char** argv){
  int fd = open("/home/d1r3ct0r/programming/systems/MyWork/fileIO/txt/numbers.txt",O_WRONLY|O_APPEND);
  if(fd == -1){
      errExit("Open file");
  }
  lseek(fd,0,SEEK_SET);
